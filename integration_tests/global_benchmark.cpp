...
#include "generated/10-global-stencil_dace_gen.cpp"
#include "generated/10-global-stencil_gtclang_gen.cpp"
...
int main(int argc, char const* argv[]) {
  ...
  double testglobal_value = 1.0;
  double global2_value = 2.0;

  // Call the gtclang stencil
  gridtools::test stencil_gtclang(dom, input, out_gtclang);
  stencil_gtclang.set_testglobal(testglobal_value);
  stencil_gtclang.set_global2(global2_value);
  stencil_gtclang.run();
  ...
  __program_IIRToSDFG(raw_input, global2_value, testglobal_value, raw_out_dace, x, y, z,
                      halo::value);
