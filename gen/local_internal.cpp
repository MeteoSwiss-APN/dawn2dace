...
// Generated on 2019-11-05  19:06:47
...
class test {
  ...
  struct stencil_15 {
    ...
    struct stage_0_0 {
      ...
      GT_FUNCTION static void apply(Evaluation& eval, interval_start__end_) {
        gridtools::clang::float_type __local_ee_31 = (eval(in_field(0, 0, 0)) + (int)5);
        eval(out_field(0, 0, 0)) = __local_ee_31;
      }
    };
 ...
 public:
  ...
  void run(storage_ijk_t in_field, storage_ijk_t out_field) {
    ...
    m_stencil_15.get_stencil()->run(p_in_field{} = in_field, p_out_field{} = out_field);
    sync_storages(in_field, out_field);
  }
