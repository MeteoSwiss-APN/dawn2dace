...
// Generated on 2019-06-17  12:12:35
...
class copy_stencil {
 public:
  struct stencil_11 {
    ...
    using axis_stencil_11 = gridtools::interval<gridtools::level<0, -1, 4>, gridtools::level<1, 1, 4>>;
    using grid_stencil_11 = gridtools::grid<axis_stencil_11>;

    struct stage_0_0 {
      using data_in = gridtools::accessor<0, gridtools::enumtype::in, gridtools::extent<0, 0, 0, 0, 0, 0>>;
    ...
    stencil_11(const gridtools::clang::domain& dom, storage_ijk_t data_in, storage_ijk_t data_out) {
      ...
      m_stencil = gridtools::make_computation<backend_t>(
          ...
          gridtools::make_multistage(
              ...
              gridtools::make_stage_with_extent<stage_0_0, extent<0, 0, 0, 0>>(p_data_in(), p_data_out())));
    }
