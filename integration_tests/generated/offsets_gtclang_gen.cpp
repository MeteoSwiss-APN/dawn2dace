// gtclang (0.0.1-93d0118-x86_64-linux-gnu-5.4.0)
// based on LLVM/Clang (3.8.0), Dawn (0.0.1)
// Generated on 2019-03-07  08:58:39
...
public:
  struct stencil_13 {
    ...
    using axis_stencil_13 =
        gridtools::interval<gridtools::level<0, -1, 4>, gridtools::level<1, 1, 4>>;
    using grid_stencil_13 = gridtools::grid<axis_stencil_13>;

    struct stage_0_0 {
      using a =
          gridtools::accessor<0, gridtools::enumtype::inout, gridtools::extent<0, 0, 0, 0, 0, 0>>;
      using b =
          gridtools::accessor<1, gridtools::enumtype::in, gridtools::extent<-1, 1, -1, 0, 0, 0>>;
    ...
    stencil_13(const gridtools::clang::domain& dom, storage_ijk_t a, storage_ijk_t b) {
      ...
      static_assert(
          ...
          "Used extents exceed halo limits.");
      static_assert(
          (static_cast<int>(storage_ijk_t::storage_info_t::halo_t::template at<0>()) >= 1) ||
              (storage_ijk_t::storage_info_t::layout_t::template at<0>() == -1),
          "Used extents exceed halo limits.");
      static_assert(
          ((-1) * static_cast<int>(storage_ijk_t::storage_info_t::halo_t::template at<0>()) <=
           -1) ||
              (storage_ijk_t::storage_info_t::layout_t::template at<0>() == -1),
          "Used extents exceed halo limits.");
      static_assert(
          ...
          "Used extents exceed halo limits.");
      static_assert(
          ((-1) * static_cast<int>(storage_ijk_t::storage_info_t::halo_t::template at<1>()) <=
           -1) ||
              (storage_ijk_t::storage_info_t::layout_t::template at<1>() == -1),
          "Used extents exceed halo limits.");
...
public:
  ...
  test(const gridtools::clang::domain& dom, storage_ijk_t a, storage_ijk_t b)
      : m_dom(dom), m_stencil_13(dom, a, b) {}
